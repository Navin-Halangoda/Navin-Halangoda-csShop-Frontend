...
export default function Adminaddproduct(){
    ...
    async function addproduct(){
        ...
        if(token==null){
            toast.error("you must loged to admin add product");
            navigate("/loging")
            return;
        }
        ...
        try{
            ...
            await axios.post(import.meta.env.VITE_BACKEND_URI+"/product/",{
                productId:productId,
                name:name,
            ...
            toast.success("product add succefuly");
    ...
    return(
        <div className="w-full min-h-full flex justify-center p-[40px] overflow-y-scroll">
            <div className="w-[800px] bg-accent rounded-3xl p-[30px] ">
                <h1 className="w-full text-[25px] text-secondary mb-[10px] font-bold gap-[10px] flex items-center"><AiOutlineProduct/> Add new product</h1>
                <div className="bg-primmary p-[20px] w-full flex flex-wrap justify-between rounded-xl shadow-2xl">
                    <div className="my-[10px] w-[45%]">
                        ...
                        <p className="w-full text-gray-500 text-right text-sm">Provide a unique ID</p>
                    ...
                    <button
                    onClick={addproduct}
                     className="w-[49%] h-[50px] bg-accent2 text-[20px] text-primmary border-2 border-accent2 hover:bg-transparent hover:text-secondary rounded-2xl mt-1.5" >Add product</button>
