    ...
    return(
        <div>
            <div className="w-full h-screen max-h-ful flex flex-row bg-accent">
                {user?
                <>
                <div className="w-[400px] bg-accent">
                    <div className="w-full h-[100px] flex items-center">
                        <img src="/logo.png" className="h-[150px]" />
                        <h1 className="text-2xl text-primmary">Admin</h1>
                        <h1 className="text-2xl text-orange-500">Panel</h1>
                    </div>
                    <div className="w-full h-[400px] text-[25px] text-primmary flex flex-col p-2 font-bold">
                        ...
                        <Link to="/admin/message"className="w-full flex h-[50px] gap-[10px] items-center"><MdOutlineRateReview/>Messages</Link>
                    </div>
                </div>
                <div className="w-[calc(100%-400px)] h-full max-h-full overflow-y-scroll border-[10px] border-accent rounded-3xl bg-primmary">
                    <Routes>
